...
@Digits(integer = Constants.Identifier.CASE_NUMBER, fraction = 0)
public @interface CaseNumber {

    String message() default "{com.deloitte.nextgen.framework.validator.annotations.CaseNumber.message}";

    Class<?>[] groups() default {};

    Class<? extends Payload>[] payload() default {};

    String regex() default PatternConstants.Identifier.CASE_NUMBER;
}
