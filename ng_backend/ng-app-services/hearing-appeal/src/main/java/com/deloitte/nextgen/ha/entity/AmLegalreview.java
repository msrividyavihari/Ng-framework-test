...
/**
 * AmLegalreview generated by hbm2java
 */
@Entity
@Table(name="AM_LEGALREVIEW"
    ,schema="IE_APP_ONLINE"
)
public class AmLegalreview  implements java.io.Serializable {
    ...
    public AmLegalreview() {
    }

	
    public AmLegalreview(long aplNum, BigInteger historySeq, String createUserId, LocalDate createDt, BigInteger uniqueTransId, LocalDate archiveDt) {
        this.aplNum = aplNum;
    ...
    public AmLegalreview(long aplNum, Character filedTimelySw, Character hearingHeldSw, Character fairIssueSw, Character validFactSw, Character vfdAiSw, Character vfdAiRcvdSw, Character vfdAiFactSw, Character phoneContactSw, Character cobTimelySw, String resNotesTxt, String goodCauseTimelyTxt, String goodCauseCobTxt, String vfdAiNoticeTxt, LocalDate phoneContactDt, String phoneContactTxt, Character resReviewSw, BigInteger historySeq, String createUserId, LocalDate createDt, LocalDate updateDt, String updateUserId, BigInteger uniqueTransId, LocalDate archiveDt, Character failSubmitRedetSw, Character cobRvwQlfySw, Character goodCauseCobSw, Character goodCauseUntimleySw) {
       this.aplNum = aplNum;
