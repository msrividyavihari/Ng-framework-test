...
/**
 * AmDisqualificationAId generated by hbm2java
 */
@Embeddable
public class AmDisqualificationAId  implements java.io.Serializable {


     private BigInteger aplNum;
     private BigInteger historySeq;

    public AmDisqualificationAId() {
    }

    public AmDisqualificationAId(BigInteger aplNum, BigInteger historySeq) {
       this.aplNum = aplNum;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AmDisqualificationAId) ) return false;
		 AmDisqualificationAId castOther = ( AmDisqualificationAId ) other; 
