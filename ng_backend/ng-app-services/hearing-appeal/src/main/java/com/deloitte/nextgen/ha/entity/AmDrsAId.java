...
/**
 * AmDrsAId generated by hbm2java
 */
@Embeddable
public class AmDrsAId  implements java.io.Serializable {
    ...
    public AmDrsAId(BigInteger aplNum, BigInteger historySeq) {
       this.aplNum = aplNum;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AmDrsAId) ) return false;
		 AmDrsAId castOther = ( AmDrsAId ) other; 
