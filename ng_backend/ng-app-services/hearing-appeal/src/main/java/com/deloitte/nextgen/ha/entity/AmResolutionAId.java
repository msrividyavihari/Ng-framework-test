...
/**
 * AmResolutionAId generated by hbm2java
 */
@Embeddable
public class AmResolutionAId  implements java.io.Serializable {


     private long aplNum;
     private BigInteger historySeq;

    public AmResolutionAId() {
    }

    public AmResolutionAId(long aplNum, BigInteger historySeq) {
       this.aplNum = aplNum;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AmResolutionAId) ) return false;
		 AmResolutionAId castOther = ( AmResolutionAId ) other; 
