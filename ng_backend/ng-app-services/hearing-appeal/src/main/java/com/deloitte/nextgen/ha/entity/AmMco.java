...
/**
 * AmMco generated by hbm2java
 */
@Entity
@Table(name="AM_MCO"
    ,schema="IE_APP_ONLINE"
)
public class AmMco  implements java.io.Serializable {
    ...
    public AmMco(AmMcoId id, BigInteger historySeq, String createUserId, LocalDate createDt, BigInteger uniqueTransId, LocalDate archiveDt) {
        this.id = id;
    ...
    public AmMco(AmMcoId id, String mcoPlan, LocalDate serviceStartDt, LocalDate serviceEndDt, String mcoNum, LocalDate actionDt, LocalDate filedDt, String issueApl, LocalDate decisionDt, String trackNum, String mcoNotes, Character extRevReqInd, LocalDate expDecDt, BigInteger historySeq, String createUserId, LocalDate createDt, BigInteger uniqueTransId, LocalDate archiveDt) {
       this.id = id;
    ...
    public AmMcoId getId() {
        return this.id;
    }
    
    public void setId(AmMcoId id) {
        this.id = id;
    }
