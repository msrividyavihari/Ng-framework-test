...
public class DcEmailDetailsRepositoryTest {

    @Autowired
    private DcEmailDetailsRepository EmailDetailsRepository;

    @Test
    public void testFindAuthRepPhoneDetailsByCaseNum() {
        Optional<DcEmailDetails> EmailDetails = EmailDetailsRepository.findAuthRepEmailDetailsByCaseNum(122256186L);
        log.info("DcEmailDetails --> {}", EmailDetails);
    }
}
