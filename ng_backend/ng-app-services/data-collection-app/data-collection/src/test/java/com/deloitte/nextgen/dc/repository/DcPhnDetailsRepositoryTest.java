...
public class DcPhnDetailsRepositoryTest {

    @Autowired
    private DcPhnDetailsRepository phnDetailsRepository;

    @Test
    public void testFindAuthRepPhoneDetailsByCaseNum() {
        Optional<DcPhnDetails> phnDetails = phnDetailsRepository.findAuthRepPhoneDetailsByCaseNum(122256186L);
        log.info("DcPhnDetails --> {}", phnDetails);
    }
}
