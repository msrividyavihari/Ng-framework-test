package com.deloitte.nextgen.dc.entities.sequence.generators;
...
public class NgSequenceGenerator extends SequenceStyleGenerator {
    public static final String CLASS_PATH = "com.deloitte.nextgen.dc.entities.sequence.generators.NgSequenceGenerator";
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
        StringBuffer sequence = new StringBuffer(prefix);
